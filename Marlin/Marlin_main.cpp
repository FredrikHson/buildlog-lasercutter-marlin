        ...
        switch((int) code_value())
        {
            ...
            case 1:
                if(Stopped == false)
                {
                    ...
                    if(code_seen('B') && !IsStopped())
                    {
                        laser_set_mode((int) code_value());
                    }
    ...
    else if(code_seen('M'))
    {
        switch((int) code_value())
        {
            ...
            case 649: // M649 set laser options
            {
                ...
                if(code_seen('R') && !IsStopped())
                {
                    laser.raster_mm_per_pulse = ((float) code_value());
                }
            ...
            case 907: // M907 Set digital trimpot motor current using axis codes.
            {
                ...
                for(int i = 0; i < NUM_AXIS; i++) if(code_seen(axis_codes[i]))
                    {
                ...
                if(code_seen('S')) for(int i = 0; i <= 4; i++)
                    {
                        digipot_current(i, code_value());
                    }
